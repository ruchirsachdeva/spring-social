...
<form id="signin" action="<c:url value="/signin/authenticate" />" method="post">
	...
	<form name="fb_signin" id="fb_signin" action="<c:url value="/signin/facebook"/>" method="POST">
        <input type="hidden" name="scope" value="publish_stream,read_stream,user_photos,email,read_insights,manage_pages,offline_access,publish_actions,user_friends, read_custom_friendlists" />
