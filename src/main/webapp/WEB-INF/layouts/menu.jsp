...
<ul class="menu">
	...
	<li><a href="<c:url value="/facebook/feed"/>">PageFeed</a></li>
	<%-- <li><a href="<c:url value="/facebook/friends"/>">Friends</a></li> --%>
	<li><a href="<c:url value="/facebook/albums"/>">Albums</a></li>
	<li><a href="<c:url value="/facebook/insight/json"/>">MyPageInsight Json</a></li>
	<li><a href="<c:url value="/facebook/feed/json"/>">OtherPage Json</a></li>
	<li><a href="<c:url value="/facebook/feed/users/json"/>">OtherPageUsers json</a></li>
</ul>
</social:connected>
